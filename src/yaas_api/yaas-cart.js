...
var Cart = function(rh) {
	...
	this.create = function(sessionId, customerNumber, currency, siteCode) {
		var cart = {
			'currency': currency,
			'siteCode': siteCode
		};
	...
	this.getCart = function(sessionId) {
		return this.requestHelper.get(pathCartBase + '?sessionId=' + sessionId + '&siteCode=main');
	};
